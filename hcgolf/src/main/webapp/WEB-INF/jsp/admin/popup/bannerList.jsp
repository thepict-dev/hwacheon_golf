...
%>
	...
	<script>
		function fn_selectList(){
			...
			$("#searchFrm").attr("action", "/_admin/popup/bannerList.do");
			$("#searchFrm").submit();
		}
		...
		function fn_insert(){
			$("#command").val("insert");
			$("#frm").attr("action", "/_admin/popup/bannerForm.do");
			$("#frm").submit();
		}
	    ...
	    <div class="container">
	        ...
	        <div class="tbl-wrap">
	            <table class="tbl01 min-type2">
	                <caption class="blind">배너 목록 테이블</caption>
	                <colgroup>
	                    <col style="width:7%">
	                    <col style="width:10%">
	                    <col style="width:*">
            ...
            <div class="pager">
                <ui:pagination paginationInfo="${paginationInfo}" type="image" jsFunction="fn_bannerList" />
            </div>
	    </div>
	</div>