...
public class BoardMaster implements Serializable {
    ...
    /** 게시판 노출 순서 */
    private String bbsOrder;
    
    /** 게시물 노출 개수 */
    private String bbsPageUnit;
    ...
    /** 글쓰기 버튼 출력여부 플래그 */
    private String writeBtnFlag = "";
    
    /** 수정 버튼 출력여부 플래그 */
    private String updateBtnFlag = "";
    
    /** 삭제 버튼 출력여부 플래그 */
    private String deleteBtnFlag = "";
    
    /** 답변 버튼 출력여부 플래그 */
    private String replyBtnFlag = "";
    
    /** 비밀글 사용여부 플래그 */
    private String secretPosblAt = "";
    
    /** 로그인 체크여부 플래그 */
    private String loginChkAt = "";
    
    /** 공지글 사용여부 플래그 */
    private String noticePosblAt = "";
    ////-------------------------------
	...
	public String getBbsOrder() {
		return bbsOrder;
	}

	public void setBbsOrder(String bbsOrder) {
		this.bbsOrder = bbsOrder;
	}

	public String getBbsPageUnit() {
		return bbsPageUnit;
	}

	public void setBbsPageUnit(String bbsPageUnit) {
	...
	public void setWriteBtnFlag(String writeBtnFlag) {
		this.writeBtnFlag = writeBtnFlag;
	}
	...
	public void setUpdateBtnFlag(String updateBtnFlag) {
	...
	public void setReplyBtnFlag(String replyBtnFlag) {
		this.replyBtnFlag = replyBtnFlag;
	}
	...
	public void setLoginChkAt(String loginChkAt) {
		this.loginChkAt = loginChkAt;
	}

	public String getNoticePosblAt() {
		return noticePosblAt;
	}

	public void setNoticePosblAt(String noticePosblAt) {
		this.noticePosblAt = noticePosblAt;
	}
}
