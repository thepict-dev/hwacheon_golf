...
public class ImagePaginationRenderer extends AbstractPaginationRenderer{
	...
	public ImagePaginationRenderer() {
		firstPageLabel    = "<a href=\"#lnk\" onclick=\"{0}({1});return false; \" class=\"pager-first\"><span class=\"screen-out\">처음</span></a>";
        previousPageLabel = "<a href=\"#lnk\" onclick=\"{0}({1});return false; \" class=\"pager-prev\"><span class=\"screen-out\">이전</span></a>";
        currentPageLabel  = "<strong class=\"pager-num active\"><span class=\"screen-out\">현재 페이지</span>{0}</strong>";
        otherPageLabel    = "<a href=\"#lnk\" onclick=\"{0}({1});return false; \" class=\"pager-num\">{2}</a>";
        nextPageLabel     = "<a href=\"#lnk\" onclick=\"{0}({1});return false; \" class=\"pager-next\"><span class=\"screen-out\">다음</span></a>";
        lastPageLabel     = "<a href=\"#lnk\" onclick=\"{0}({1});return false; \" class=\"pager-last\"><span class=\"screen-out\">마지막</span></a>";
	}
